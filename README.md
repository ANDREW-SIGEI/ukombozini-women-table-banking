...
<!-- ![](https://github.com/ANDREW-SIGEI/ukombozini-women-table-banking/actions/workflows/0-start-exercise.yml/badge.svg) -->
...
2. In the new tab, most of the prompts will automatically fill in for you.
   ...
   - We recommend creating a public repository, as private repositories will [use Actions minutes](https://docs.github.chttps://github.com/ANDREW-SIGEI/ukombozini-women-table-banking/billing/managing-billing-for-github-actions/about-billing-for-github-actions).
...
4. Click **Start Exercise**. Follow the step-by-step instructions and feedback will be provided as you progress.
   ...
   <a id="start-exercise" href="https://github.com/ANDREW-SIGEI/ukombozini-women-table-banking/issues/1">
